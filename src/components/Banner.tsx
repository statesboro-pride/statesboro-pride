...
export default function Banner(props: BannerProps) {
  ...
  const xsContainerStyle: MUI.CSSProperties = { backgroundImage: `url(${xsBackgroundImage})` };
  const mdContainerStyle: MUI.CSSProperties = { backgroundImage: `url(${mdBackgroundImage})` };
